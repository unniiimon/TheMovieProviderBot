...
BOT_TOKEN = environ.get('BOT_TOKEN', "7668773178:AAHndxC_Oll-K98FMhd7E3Z-jMu13SyiBAY")
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/moviecenter225') # How to open tutorial link for verification
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002375600984')) #Log channel id ( make sure bot is admin )
